  ...
  const [project, setProject] = useState([
    {
      ...
      description: ` A freelance mobile-responsive website created for the client, Bluebonnet Records, located in Lockhart, TX. The layout clearly presents shop details, links to maps, social media, and shops. `,
      challenges: ` There were design challenges as to where to place the details the client needed, how they will differ on mobile screens, as well as the overall color scheme. I wanted the details to be present and above the fold, and the colors to blend well. Working with SVGs within CSS and Flexbox was a newer concept, but I enjoyed learning how they work. `,
