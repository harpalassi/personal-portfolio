  ...
  const [project, setProject] = useState([
    {
      ...
      description: ` A freelance mobile-responsive website created for the client, Bluebonnet Records, located in Lockhart, TX. Provides links to all relevant information and shops. `,
