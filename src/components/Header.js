    ...
    <header id="about">
      <div className="row-wrap">
        ...
        <div className="title">
          <h1>HARPAL ASSI</h1>
          <p>
            I'm Harpal! I'm a full-stack web developer, tech addict, and musician born in the UK and
          ...
          <p>
            ...
            technologies such as React, JavaScript, CSS3, HTML5, MySQL, Node.js, Express, and
